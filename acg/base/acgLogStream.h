...
namespace acg
{
	namespace base
	{
		...
		template<int SIZE>
		class FixedBuffer :public CACGNoCopyable
		{
		public:
			FixedBuffer()
				: cur_(data_)
			...
			CACGStringPiece toStringPiece() const { return CACGStringPiece(data_, length()); }
		...
		public:
			...
			self& operator<<(const char *str)
			{
				...
				{
					size_t  strLen;
					ACG_CHECK_STR(StringCchLengthA(str, kSmallBuffer, &strLen))
